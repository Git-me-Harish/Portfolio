...
function AnimatedHighlight({
  children,
  color = '#3b82f6', // default blue; pass hex or css var
}: {
  children: string
  color?: string
}) {
...
export function AboutGrid({ isMobile }: AboutGridProps) {
  ...
  const bioHighlights: Highlight[] = [
    { text: 'deep learning, NLP', color: '#3b82f6' },       // blue
    { text: 'production ML pipelines', color: '#00cc88' },  // accent green
    { text: 'full-stack engineering', color: '#a855f7' },   // purple
  ]
              ...
              <div className="p-5">
                ...
                >
                  ...
                  <motion.div
                    ...
                    style={{ backgroundImage: 'linear-gradient(to bottom, transparent 40%, rgba(0,204,136,0.04) 50%, transparent 60%)' }}
                    animate={{ y: ['-100%', '200%'] }}
